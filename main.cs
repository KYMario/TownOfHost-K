...
=======
    ...
    public class Main : BasePlugin
    {
        ...
        public const string PluginVersion = "51.13.30.13";//ほんとはx.y.z表記にしたかったけどx.y.z.km.ks表記だと警告だされる
        public const string PluginShowVersion = "51.13.30<sub>.13</sub>";
