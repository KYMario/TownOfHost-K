...
namespace TownOfHost
{
    ...
    public class Main : BasePlugin
    {
        ...
        public const string PluginVersion = "51.14.31.12";//ほんとはx.y.z表記にしたかったけどx.y.z.km.ks表記だと警告だされる
        public const string PluginShowVersion = "51.14.31.12";
        public const string ModVersion = ".14.31";//リリースver用バージョン変更
